...
CREATE INDEX idx_bot_config_company  ON bot_config(company_business_number);
CREATE INDEX idx_rule_company        ON rules(company_business_number);
...
-- );
--
-- CREATE INDEX idx_file_upload_history_company ON file_upload_history(company_business_number);
...
CREATE TABLE file_classify_summary (
    ...
    -- classification breakdown
                                       ...
                                       CONSTRAINT uq_file_classify_summary UNIQUE (file_id, company_business_number),
...
CREATE INDEX idx_file_classify_summary_company ON file_classify_summary(company_business_number);
