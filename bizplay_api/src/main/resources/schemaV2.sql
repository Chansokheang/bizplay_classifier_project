...
CREATE TABLE conversational_agent_session (
                                              ...
                                              CONSTRAINT ck_conversational_agent_status CHECK (
                                                  status IN ('COLLECTING', 'READY_FOR_REVIEW', 'APPROVED', 'POSTED', 'CANCELLED')
                                                  )
);
...
CREATE INDEX idx_conversational_agent_session_type_status ON conversational_agent_session(agent_type, status);
CREATE INDEX idx_conversational_trip_plan_corp_no ON conversational_trip_plan(corp_no);
CREATE INDEX idx_conversational_trip_plan_agent_session ON conversational_trip_plan(agent_session_id);
